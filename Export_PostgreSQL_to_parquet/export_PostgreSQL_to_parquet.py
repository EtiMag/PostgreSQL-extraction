...
with open("Export_PostgreSQL_to_parquet/parameters.yml", "r") as parameters_file:
...
with open("Export_PostgreSQL_to_parquet/fetch_tables_to_extract.sql", "r") as request_file:
